...
public abstract class ModifyRegionUtils {
    ...
    /**
     * Create new set of regions on the specified file-system. NOTE: that you should
     * add the regions
     ...
     * @param newRegions      {@link RegionInfo} that describes the regions to
     *                        create
     * @param task            {@link RegionFillTask} custom code to populate region
     *                        after creation
     */
    ...
    public static RegionInfo createRegion(final Configuration conf, final Path rootDir,
            ...
            throws IOException {
        // 1. Create HRegion
        // The WAL subsystem will use the default rootDir rather than the passed in
        // rootDir
