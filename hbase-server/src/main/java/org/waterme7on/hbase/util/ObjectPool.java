...
/**
 * A thread-safe shared object pool in which object creation is expected to be
 * lightweight, and the
 * objects may be excessively created and discarded.
 */
public abstract class ObjectPool<K, V> {
    /**
     * An {@code ObjectFactory} object is used to create new shared objects on
     * demand.
     */
    public interface ObjectFactory<K, V> {
        /**
         * Creates a new shared object associated with the given {@code key}, identified
         * by the
         * {@code equals} method. This method may be simultaneously called by multiple
         * threads with the
    ...
    /**
     * The default initial capacity, used when not otherwise specified in a
     * constructor.
     */
    public static final int DEFAULT_INITIAL_CAPACITY = 16;

    /**
     * The default concurrency level, used when not otherwise specified in a
     * constructor.
     */
    public static final int DEFAULT_CONCURRENCY_LEVEL = 16;

    /**
     * Creates a new pool with the default initial capacity (16) and the default
     * concurrency level
     * (16).
     * 
    ...
    /**
     * Creates a new pool with the given initial capacity and the default
    ...
    /**
     * Creates a new pool with the given initial capacity and the given concurrency
     * level.
     * 
     * @param objectFactory    the factory to supply new objects on demand
     * @param initialCapacity  the initial capacity to keep objects in the pool
    ...
    /**
     * Removes stale references of shared objects from the pool. References newly
     * becoming stale may
     * still remain.
     * <p/>
    ...
    /**
     * Returns a shared object associated with the given {@code key}, which is
     * identified by the
     * {@code equals} method.
     * 
    ...
    /**
     * Returns an estimated count of objects kept in the pool. This also counts
     * stale references, and
