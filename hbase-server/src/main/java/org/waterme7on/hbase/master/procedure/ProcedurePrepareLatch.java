...
public abstract class ProcedurePrepareLatch {
    ...
    /**
     * Create a latch if the client does not have async proc support. This uses the
     * default 1.1
     * version.
     * 
     * @return a CompatibilityLatch or a NoopLatch if the client has async proc
     *         support
     */
