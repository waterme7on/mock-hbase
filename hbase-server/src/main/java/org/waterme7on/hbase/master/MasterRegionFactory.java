...
public final class MasterRegionFactory {
        ...
        // Use the character $ to let the log cleaner know that this is not the normal
        // wal file.
        public static final String ARCHIVED_WAL_SUFFIX = "$masterlocalwal$";

        // this is a bit trick that in StoreFileInfo.validateStoreFileName, we just test
        // if the file name
        // contains '-' to determine if it is a valid store file, so here we have to add
        // '-'in the file
