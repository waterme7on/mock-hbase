 ...
 * RegionServerCoprocessor, and WALCoprocessor. Do NOT implement this interface
 * directly. Unless an
 * implementation implements one (or more) of the above mentioned 4
 * coprocessors, it'll fail to be
 * loaded by any coprocessor host. Example: Building a coprocessor to observe
 * Master operations.
 *
 * <pre>
...
public interface Coprocessor {
    ...
    /**
     * Called by the {@link CoprocessorEnvironment} during it's own startup to
     * initialize the
     * coprocessor.
     */
    ...
    /**
     * Called by the {@link CoprocessorEnvironment} during it's own shutdown to stop
     * the coprocessor.
     */
