...
public class ReadOnlyConfiguration extends Configuration {
    ...
    public synchronized void reloadConfiguration() {
        // This is a write operation. We need to allow it though because if any
        // Configuration in
        // current JVM context calls addDefaultResource, this forces a reload of all
        // Configurations
        // (all Configurations are 'registered' by the default constructor. Rather than
        // turn
