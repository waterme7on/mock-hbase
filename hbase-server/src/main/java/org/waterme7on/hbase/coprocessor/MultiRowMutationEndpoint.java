 ...
 * {@link HRegion#mutateRowsWithLocks(Collection, Collection, long, long)} and
 * Coprocessor
 * endpoints. We can also specify some conditions to perform conditional update.
 * Defines a protocol
 * to perform multi row transactions. See {@link MultiRowMutationEndpoint} for
 * the implementation.
 * <br>
 * See {@link HRegion#mutateRowsWithLocks(Collection, Collection, long, long)}
 * for details and
 * limitations. <br>
 * Example: <code>
 * Put p = new Put(row1);
...
public class MultiRowMutationEndpoint extends MultiRowMutationService implements RegionCoprocessor {
     ...
     * region where this
     * coprocessor is loaded. Since this is a coprocessor endpoint, it always
     * expects to be loaded on
