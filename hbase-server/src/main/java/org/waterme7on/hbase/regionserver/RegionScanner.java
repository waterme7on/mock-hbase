...
public interface RegionScanner extends InternalScanner {
    ...
    /**
     * @return True if a filter indicates that this scanner will return no further
     *         rows.
     ...
     * may come before the
     * current position. Always seeks to the beginning of a row boundary. if row is
     * null
     */
    ...
    /**
     * @return The limit on the number of cells to retrieve on each call to next().
     *         See
    ...
    /**
     * @return The Scanner's {@link org.apache.hadoop.hbase.client.Scan#ID_ATRIBUTE}
     *         value, or null if
     *         not set.
     */
     ...
     * readpoint, start and
     * close a region operation, an synchronize on the scanner object. Caller should
     * maintain and
    ...
    /**
     * Grab the next row's worth of values. The {@link ScannerContext} is used to
     * enforce and track
     * any limits associated with this call. Any progress that exists in the
     * {@link ScannerContext}
     * prior to calling this method will be LOST if
     * {@link ScannerContext#getKeepProgress()} is false.
     * Upon returning from this method, the {@link ScannerContext} will contain
     * information about the
     * progress made towards the limits. This is a special internal method to be
     * called from
     * coprocessor hooks to avoid expensive setup. Caller must set the thread's
     * readpoint, start and
     ...
     * 
     * @param result         return output array
     * @param scannerContext The {@link ScannerContext} instance encapsulating all
     *                       limits that should
     *                       be tracked during calls to this method. The progress
