...
public final class StoreUtils {
     ...
     * Store files that
     * were created by a mapreduce bulk load are ignored, as they do not correspond
     * to any specific
    ...
    /**
     * Gets the approximate mid-point of the given file that is optimal for use in
     * splitting it.
     * 
     * @param file       the store file
     * @param comparator Comparator used to compare KVs.
     * @return The split point row, or null if splitting is not possible, or reader
     *         is null.
     */
    static Optional<byte[]> getFileSplitPoint(HStoreFile file, CellComparator comparator)
        ...
        // if the midkey is the same as the first or last keys, we cannot (ever) split
        // this region.
    ...
    public static Configuration createStoreConfiguration(Configuration conf, TableDescriptor td,
        ...
        // CompoundConfiguration will look for keys in reverse order of addition, so
        // we'd
