 ...
 * {@link Cell}s. When
 * asked to flush, current memstore is moved to snapshot and is cleared. We
 * continue to serve edits
 * out of new memstore and backing snapshot until flusher reports in that the
 * flush succeeded. At
...
public class DefaultMemStore extends AbstractMemStore {
     ...
     * enough. See hbase-900.
     * Fills memstores then waits so user can heap dump and bring up resultant hprof
     * in something like
