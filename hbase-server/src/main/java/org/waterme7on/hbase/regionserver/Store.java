...
public interface Store {
    ...
    /**
     * The default priority for user-specified compaction requests. The user gets
     * top priority unless
     ...
     * 
     * @return <code>true</code> if number of store files is greater than the number
     *         defined in
     *         minFilesToCompact
     */
    ...
    /**
     * Returns whether this store is splittable, i.e., no reference file in this
     * store.
     */
    boolean canSplit();

    /**
     * Returns <code>true</code> if the store has any underlying reference files to
     * older HFiles
     */
    ...
    /**
     * @return The amount of memory we could flush from this memstore; usually this
     *         is equal to
     *         {@link #getMemStoreSize()} unless we are carrying snapshots and then
     *         it will be the
     ...
     * intermediate levels, and the leaf level for multi-level indexes, or just the
     * root level for
     ...
     * opened, and removes
     * the store file readers for store files no longer available. Mainly used by
     * secondary region
    ...
    /**
     * This value can represent the degree of emergency of compaction for this
     * store. It should be
     * greater than or equal to 0.0, any value greater than 1.0 means we have too
     * many store files.
     * <ul>
     ...
     * </ul>
     * <p>
     * And for striped stores, we should calculate this value by the files in each
     * stripe separately
     * and return the maximum value.
     * <p>
     * It is similar to {@link #getCompactPriority()} except that it is more
     * suitable to use in a
     * linear formula.
     */
    ...
    /**
     * @return a read only configuration of this store; throws
    ...
    /**
     * Returns count of requests which could have used bloom filters, but they
     * weren't configured or
     * loaded.
     */
