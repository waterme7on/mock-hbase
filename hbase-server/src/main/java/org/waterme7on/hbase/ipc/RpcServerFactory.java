...
public class RpcServerFactory {
    ...
    public static RpcServer createRpcServer(final Server server, final String name, final InetSocketAddress bindAddress,
                                            Configuration conf, RpcScheduler scheduler) throws IOException {
        return createRpcServer(server, name, bindAddress, conf, scheduler, true);
    }
