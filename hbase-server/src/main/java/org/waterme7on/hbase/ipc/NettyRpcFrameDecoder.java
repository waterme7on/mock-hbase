...
public class NettyRpcFrameDecoder extends ByteToMessageDecoder {
    ...
    private void handleTooBigRequest(ChannelHandlerContext ctx, ByteBuf in) throws IOException {
        ...
        // RequestTooBigException reqTooBigEx = new
        // RequestTooBigException(requestTooBigMessage);
        ...
        // } else {
        // reqTooBig.setResponse(null, null, new
        // DoNotRetryIOException(requestTooBigMessage),
        // requestTooBigMessage);
        // }

        // To guarantee that the message is written and flushed before closing the
        // channel,
    ...
    /**
     * Reads variable length 32bit int from buffer This method is from
     * ProtobufVarint32FrameDecoder in
