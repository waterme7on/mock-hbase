 ...
 * way to pass the
 * EventLoopGroup to {@code AsyncRpcClient} if we want to use a single
 * {@code EventLoopGroup} for
 * the whole process.
 * 
 * @since 2.0.0
 */
public final class NettyRpcClientConfigHelper {
    ...
    /**
     * Name of property to change netty rpc client eventloop thread count. Default
     * is 0. Tests may set
