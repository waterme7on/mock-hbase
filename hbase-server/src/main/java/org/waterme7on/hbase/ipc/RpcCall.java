...
/**
 * Interface of all necessary to carry out a RPC method invocation on the
 * server.
 */
public interface RpcCall extends RpcCallContext {
    ...
    /**
     * Used to calculate the request call queue size. If the total request call size
     * exceeds a limit,
    ...
    /**
     * Send the response of this RPC call. Implementation provides the underlying
     * facility
