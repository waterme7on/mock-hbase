...
public abstract class AbstractProcedureScheduler implements ProcedureScheduler {
    ...
    // ==========================================================================
    /**
     * Add the procedure to the queue. NOTE: this method is called with the sched
     * lock held.
     * 
    ...
    // ==========================================================================
    /**
     * Fetch one Procedure from the queue NOTE: this method is called with the sched
     * lock held.
     * 
    ...
    // ==========================================================================
    /**
     * Returns the number of elements in this queue. NOTE: this method is called
     * with the sched lock
     * held.
     * 
    ...
    /**
     * Returns true if there are procedures available to process. NOTE: this method
     * is called with the
     * sched lock held.
     * 
    ...
    /**
     * Wake up all of the given events. Note that we first take scheduler lock and
     * then wakeInternal()
