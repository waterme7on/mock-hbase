 ...
 * <p>
 * RemoteProcedureExceptions are sent to 'remote' peers to signal an abort in
 * the face of failures.
 * When serialized for transmission we encode using Protobufs to ensure version
 * compatibility.
 * <p>
 * RemoteProcedureException exceptions contain a Throwable as its cause. This
 * can be a "regular"
 * exception generated locally or a ProxyThrowable that is a representation of
 * the original
 * exception created on original 'remote' source. These ProxyThrowables have
 * their their stacks
...
public class RemoteProcedureException extends ProcedureException {
    /**
     * Name of the throwable's source such as a host or thread name. Must be
     * non-null.
     */
    private final String source;

    /**
     * Create a new RemoteProcedureException that can be serialized. It is assumed
     * that this came form
     * a local source.
     * 
    ...
    /**
     * Takes a series of bytes and tries to generate an RemoteProcedureException
     * instance for it.
     * 
