...
public class AsyncProtobufLogWriter extends AbstractProtobufLogWriter
    ...
    public AsyncProtobufLogWriter(EventLoopGroup eventLoopGroup,
        ...
        // Reuse WAL_ROLL_WAIT_TIMEOUT here to avoid an infinite wait if somehow a wait
        // on a future
        // never completes. The objective is the same. We want to propagate an exception
        // to trigger
    ...
    public synchronized void close() throws IOException {
        ...
        /**
         * We have to call {@link AsyncFSOutput#getSyncedLength()} after
         * {@link AsyncFSOutput#close()}
         * to get the final length synced to underlying filesystem because
         * {@link AsyncFSOutput#close()}
