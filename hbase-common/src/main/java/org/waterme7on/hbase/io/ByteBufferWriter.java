...
public interface ByteBufferWriter {
  ...
  /**
   * Writes <code>len</code> bytes from the specified ByteBuffer starting at
   ...
   */
  // This is pure performance oriented API been added here. It has nothing to do
  // with
  // ByteBuffer and so not fully belong to here. This allows an int to be written
  // at one go instead
