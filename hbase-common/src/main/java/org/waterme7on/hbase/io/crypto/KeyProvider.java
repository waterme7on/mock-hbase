...
public interface KeyProvider {
   ...
   * 
   * @return the keys corresponding to the supplied alias, or null if a key is not
   *         found
   */
   ...
   * @return an array of keys corresponding to the supplied aliases, an entry will
   *         be null if a key
   *         is not found
   */
