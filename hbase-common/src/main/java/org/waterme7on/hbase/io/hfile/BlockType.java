...
/**
 * Various types of HFile blocks. Ordinal values of these enum constants must
 * not be relied upon.
...
public enum BlockType {
   ...
   * DATA and
   * ENCODED_DATA get the same id using this method (overridden for
   * {@link #ENCODED_DATA}).
   * 
   ...
   */
  // System.arraycopy is static native. We can't do anything about this until
  // minimum JDK is 9.
  ...
  /**
   * Reads a magic record of the length {@link #MAGIC_LENGTH} from the given byte
   * buffer and expects
