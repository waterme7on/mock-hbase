...
/**
 * A basic KeyProvider that can resolve keys from a protected KeyStore file on
 * the local filesystem.
 * It is configured with a URI passed in as a String to init(). The URI should
 * have the form:
 * <p>
 *
 * <pre>
 ...
 * every JRE. The latter is the certificate store for the SunJCE cryptography
 * extension, or PKCS
 ...
 * <p>
 * If the store was created with a password, the password can be specified using
 * the option
 * 'password'.
 * <p>
 * For example:
