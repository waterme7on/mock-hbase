 ...
 */
package org.waterme7on.hbase.io.compress;
...
public final class Compression {
  ...
  // Our ReusableStreamGzipCodec fixes an inefficiency in Hadoop's Gzip codec,
  // allowing us to
  ...
  /**
   * Compression algorithms. The ordinal of these cannot change or else you risk
   * breaking all
   * existing HFiles out there. Even the ones that are not compressed! (They use
   * the NONE algorithm)
   */
  ...
  public static enum Algorithm {
     ...
     * <p>
     * NOTE: Experts only. This can only be done safely during process startup,
     * before the
     * algorithm's codecs are in use. If the codec implementation is changed, the
     * new implementation
     * may not be fully compatible with what was loaded at static initialization
     * time, leading to
    ...
    /**
     * Creates a compression stream without any additional wrapping into buffering
     * streams.
     */
   ...
   * 
   * @return Array of strings, each represents a supported compression algorithm.
   *         Currently, the
  ...
  /**
   * Load a codec implementation for an algorithm using the supplied
   * configuration.
   * 
  ...
  public static void main(String[] args) throws Exception {
    ...
    for (Algorithm algo : Algorithm.class.getEnumConstants()) {
      try {
        ...
        // Ignore failures to load codec native implementations while building the
        // report.
