...
import org.waterme7on.hbase.io.ByteBuffInputStream;
import org.waterme7on.hbase.io.TagCompressionContext;
import org.waterme7on.hbase.io.compress.CanReinit;
import org.waterme7on.hbase.io.compress.Compression;
import org.waterme7on.hbase.io.crypto.Cipher;
import org.waterme7on.hbase.io.crypto.Decryptor;
import org.waterme7on.hbase.io.crypto.Encryption;
import org.waterme7on.hbase.io.hfile.HFileContext;
import org.waterme7on.hbase.io.util.BlockIOUtils;
    ...
    try {
      ...
      if (compression != Compression.Algorithm.NONE) {
        ...
        try {
          ...
          // Some algorithms don't return decompressors and accept null as a valid
          // parameter for
          // same when creating decompression streams. We can ignore these cases wrt
          // reinit.
