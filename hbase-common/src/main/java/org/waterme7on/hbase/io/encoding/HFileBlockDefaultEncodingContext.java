...
import org.waterme7on.hbase.io.ByteArrayOutputStream;
...
import org.waterme7on.hbase.io.crypto.Encryptor;
import org.waterme7on.hbase.io.hfile.BlockType;
...
public class HFileBlockDefaultEncodingContext implements HFileBlockEncodingContext {
  ...
  public HFileBlockDefaultEncodingContext(Configuration conf, DataBlockEncoding encoding,
    ...
    Compression.Algorithm compressionAlgorithm = fileContext.getCompression() == null ? Compression.Algorithm.NONE
        : fileContext.getCompression();
    if (compressionAlgorithm != Compression.Algorithm.NONE) {
      if (compressor == null) {
        compressor = compressionAlgorithm.getCompressor();
        // Some algorithms don't return compressors and accept null as a valid parameter
        // for
