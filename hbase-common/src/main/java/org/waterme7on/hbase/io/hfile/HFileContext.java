 ...
 */
package org.waterme7on.hbase.io.hfile;
...
import org.waterme7on.hbase.io.encoding.DataBlockEncoding;
import org.waterme7on.hbase.io.encoding.IndexBlockEncoding;
...
/**
 * Read-only HFile Context Information. Meta data that is used by
 * HFileWriter/Readers and by
 * HFileBlocks. Create one using the {@link HFileContextBuilder} (See HFileInfo
 * and the HFile
 * Trailer class).
 * 
...
public class HFileContext implements HeapSize, Cloneable {
  ...
  /**
   * Returns true when on-disk blocks are compressed, and/or encrypted; false
   * otherwise.
   */
  ...
  /**
   * HeapSize implementation. NOTE : The heap size should be altered when new
   * state variable are
   * added.
   * 
