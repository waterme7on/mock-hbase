...
/**
 * Provide access to all index block encoding algorithms. All of the algorithms
 * are required to have
 * unique id which should <b>NEVER</b> be changed. If you want to add a new
 * algorithm/version,
 * assign it a new id. Announce the new id in the HBase mailing list to prevent
 * collisions.
 */
