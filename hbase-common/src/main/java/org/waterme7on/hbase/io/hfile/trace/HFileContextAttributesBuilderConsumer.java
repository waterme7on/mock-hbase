 ...
 */
package org.waterme7on.hbase.io.hfile.trace;
...
/**
 * <p>
 * Populate fields on an {@link AttributesBuilder} based on an
 * {@link HFileContext}. Passed around
...
public class HFileContextAttributesBuilderConsumer implements Consumer<AttributesBuilder> {
  ...
  /**
   * Used to place extract attributes pertaining to the {@link HFileContext} that
   * scopes the active
   * {@link Context}.
   */
  public static final ContextKey<Consumer<AttributesBuilder>> CONTEXT_KEY = ContextKey
      .named("db.hbase.io.hfile.context_attributes");
  ...
  public HFileContextAttributesBuilderConsumer setReadType(final ReadType readType) {
    // TODO: this is not a part of the HFileBlock, its context of the operation.
    // Should track this
    // detail elsewhere.
  ...
  public void accept(AttributesBuilder builder) {
    ...
    if (hFileContext.getEncryptionContext() != null
