...
import org.waterme7on.hbase.io.hfile.HFileContext;
...
public interface DataBlockEncoder {
        // TODO: This Interface should be deprecated and replaced. It presumes hfile and
        // carnal knowledge
        // of
        // Cell internals. It was done for a different time. Remove. Purge.
        /**
         * Starts encoding for a block of KeyValues. Call
         * {@link #endBlockEncoding(HFileBlockEncodingContext, DataOutputStream, byte[])}
         * to finish
         * encoding of a block.
         */
        ...
        /**
         * Encodes a KeyValue. After the encode,
         * {@link EncodingState#postCellEncode(int, int)} needs to
        ...
        /**
         * Ends encoding for a block of KeyValues. Gives a chance for the encoder to do
         * the finishing
        ...
        /**
         * Return first key in block as a cell. Useful for indexing. Typically does not
         * make a deep copy
         * but returns a buffer wrapping a segment of the actual block's byte array.
         * This is because the
        ...
        /**
         * Creates a encoder specific encoding context store configuration encoding
         * strategy used header
         * bytes to be written, put a dummy header here if the header is unknown HFile
         * meta data
         * 
        ...
        /**
         * An interface which enable to seek while underlying data is encoded. It works
         * on one HFileBlock,
        ...
        interface EncodedSeeker {
                ...
                /**
                 * From the current position creates a cell using the key part of the current
                 * buffer
                 * 
                ...
                /**
                 * Does a shallow copy of the value at the current position. A shallow copy is
                 * possible because
                 * the returned buffer refers to the backing array of the original encoded
                 * buffer.
                 * 
                 ...
                 * 
                 * @return -1 is the passed key is smaller than the current key, 0 if equal and
                 *         1 if greater
                 */
