 ...
 * {@link #INITIAL_MIN_TIMESTAMP} and {@link #INITIAL_MAX_TIMESTAMP} only. Gets
 * freaked out if
...
public class TimeRange {
  ...
  private static final TimeRange ALL_TIME = new TimeRange(INITIAL_MIN_TIMESTAMP, INITIAL_MAX_TIMESTAMP);
   ...
   * @deprecated This is made @InterfaceAudience.Private in the 2.0 line and above
   *             and may be
   *             changed to private or removed in 3.0. Use
   *             {@link #withinTimeRange(long)} instead
   */
  @Deprecated
   ...
   */
  // This method came from TimeRangeTracker. We used to go there for this function
  // but better
   ...
   * 
   * @return -1 if timestamp is less than timerange, 0 if timestamp is within
   *         timerange, 1 if
