 ...
 * Not thread safe!
 * <p>
 * Please note that the reads will cause position movement on wrapped
 * ByteBuffer.
 */
...
public class ByteBufferInputStream extends InputStream {
   ...
   * is available
   * because the end of the stream has been reached, the value <code>-1</code> is
   * returned.
   * 
   ...
   * be skipped if the
   * end of the input stream is reached. The actual number <code>k</code> of bytes
   * to be skipped is
