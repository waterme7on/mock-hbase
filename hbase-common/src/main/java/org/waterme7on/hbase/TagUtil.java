...
public final class TagUtil {
    ...
    /**
     * Add to <code>tagsOrNull</code> any Tags <code>cell</code> is carrying or null
     * if none.
     */
    ...
    public static List<Tag> carryForwardTTLTag(final List<Tag> tagsOrNull, final long ttl) {
        ...
        // we'll be only thing
        // in the array so set its size to '1' (I saw this being done in earlier version
        // of
        // tag-handling).
        if (tags == null) {
    ...
    /**
     * Write a list of tags into a byte array Note : these are all purely internal
     * APIs. It helps in
     * cases where we have set of tags and we would want to create a cell out of it.
     * Say in Mobs we
     * create a reference tags to indicate the presence of mob data. Also note that
     * these are not
     * exposed to CPs also
     * 
