...
public class IndividualBytesFieldCell implements ExtendedCell, Cloneable {
    ...
    public byte[] getRowArray() {
        // If row is null, the constructor will reject it, by {@link
        // KeyValue#checkParameters()},
    ...
    public short getRowLength() {
        ...
        // {@link KeyValue#checkParameters()}, so it is safe to call rLength and make
        // the type
        // conversion.
    ...
    public byte getFamilyLength() {
        // If fLength is invalid, the constructor will reject it, by {@link
        // KeyValue#checkParameters()},
    ...
    public long heapSize() {
        // Size of array headers are already included into overhead, so do not need to
        // include it for
        // each byte array
