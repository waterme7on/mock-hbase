...
/**
 * Extension to {@link Cell} with server side required functions. Server side
 * Cell implementations
 * must implement this.
 */
@InterfaceAudience.Private
public interface ExtendedCell extends RawCell {
     ...
     * 
     * @param withTags Whether to write tags.
     * @return Bytes count required to serialize this Cell in a {@link KeyValue}
     *         format.
     */
    // TODO remove the boolean param once HBASE-16706 is done.
    ...
    /**
     * Does a deep copy of the contents to a new memory area and returns it as a new
     * cell.
     * 
     * @return The deep cloned cell
     */
    default ExtendedCell deepClone() {
        // When being added to the memstore, deepClone() is called and KeyValue has less
        // heap overhead.
    ...
    /**
     * Returns The byte representation of the KeyValue.TYPE of this cell: one of
     * Put, Delete, etc
     */
    byte getTypeByte();
}
