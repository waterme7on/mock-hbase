...
public class RefCnt extends AbstractReferenceCounted {
   ...
   * zero, the recycler will do nothing. Usually, an Heap {@link ByteBuff} will
   * use this kind of
   * refCnt to track its life cycle, it help to abstract the code path although
   * it's not really
