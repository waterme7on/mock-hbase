...
public final class UnsafeAccess {
    ...
    /**
     * Reads a short value at the given buffer's offset considering it was written
     * in big-endian
     * format.
     * 
    ...
    /**
     * Reads a short value at the given Object's offset considering it was written
     * in big-endian
     * format.
     * 
     * @return short value at offset
    ...
    /**
     * Reads an int value at the given buffer's offset considering it was written in
     * big-endian
     * format.
     * 
    ...
    /**
     * Reads a int value at the given Object's offset considering it was written in
     * big-endian format.
     * 
     * @return int value at offset
     */
    ...
    /**
     * Reads a long value at the given buffer's offset considering it was written in
     * big-endian
     * format.
     * 
    ...
    /**
     * Reads a long value at the given Object's offset considering it was written in
     * big-endian
     * format.
     * 
     * @return long value at offset
    ...
    // APIs to copy data. This will be direct memory location copy and will be much
    // faster
    /**
    ...
    /**
     * Copies specified number of bytes from given offset of {@code src} ByteBuffer
     * to the
     * {@code dest} array.
     * 
    ...
    /**
     * Copies specified number of bytes from given offset of {@code src} buffer into
     * the {@code dest}
     * buffer.
     * 
     * @param src        source buffer
