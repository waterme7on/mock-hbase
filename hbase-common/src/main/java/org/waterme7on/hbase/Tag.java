...
/**
 * Tags are part of cells and helps to add metadata about them. Metadata could
 * be ACLs, visibility
 * labels, etc.
 * <p>
 * Each Tag is having a type (one byte) and value part. The max value length for
 * a Tag is 65533.
 * <p>
...
public interface Tag {
    ...
    /**
     * Custom tags if created are suggested to be above this range. So that it does
     * not overlap with
     * internal tag types
     */
    ...
    /**
     * Return an array containing the value bytes if {@link #hasArray()} returns
     * true.
     * <p>
    ...
    /**
     * Returns tag value in a new byte array. Primarily for use client-side. If
     * server-side, use
